 ...
 <body>
    ...
    @if($users->count())
       <table style="border: solid 1px #000;">
          <thead>
          <tr>
            <th style="width: 200px; border-bottom: solid 1px #000;"> Número de Colaborador </th>
            <th style="width: 200px; border-bottom: solid 1px #000;"> Nombre Completo </th>
            <th style="width: 200px; border-bottom: solid 1px #000;"> Nombre de usuario </th>
          ...
          @foreach($users as $item)
             <tr>
                <td style="text-align: center;"> {{ $item->id_collaborator }} </td>
